...
#include "2016_plugin.hpp"

using namespace gazebo;

GZ_REGISTER_WORLD_PLUGIN(FRC2016Plugin)
...
/////////////////////////////////////////////////
FRC2016Plugin::FRC2016Plugin()
{
}

/////////////////////////////////////////////////
void FRC2016Plugin::Load(physics::WorldPtr _world, sdf::ElementPtr /*_sdf*/)
{
  GZ_ASSERT(_world, "FRC2016Plugin world pointer is NULL");
  this->world = _world;
  ...
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          std::bind(&FRC2016Plugin::OnUpdate, this));
...
/////////////////////////////////////////////////
void FRC2016Plugin::UpdateCastleBalls(const physics::Model_V &_models)
{
...
/////////////////////////////////////////////////
void FRC2016Plugin::LaunchBall(const physics::ModelPtr _model, Team _side)
{
...
/////////////////////////////////////////////////
void FRC2016Plugin::GoalVisuals()
{
...
/////////////////////////////////////////////////
void FRC2016Plugin::UpdateScore()
{
  ignition::msgs::Marker markerMsg;
  ignition::msgs::StringMsg response;
  bool result;
